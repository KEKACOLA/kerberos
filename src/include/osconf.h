...
#else /* !_WINDOWS */
#if TARGET_OS_MAC
#define DEFAULT_SECURE_PROFILE_PATH "/Library/Preferences/edu.mit.Kerberos:/etc/krb5.conf"
...
#else
#define DEFAULT_PLUGIN_BASE_DIR "/usr/lib/krb5/plugins"
#endif
